#!/bin/bash
# Write a shell script that display one of ten uniqe fortune cookie message at random each it is run.
# genrate a number (random number) between 1 and 10 
r=$(( $RANDOM%10+0 ))
# Quotes author name
author="\t --Bhagavad Gita."

#Store cookies or quotes in and array
array=( "Neither in this world nor elsewhere is there any happiness in store for him who always doubts." 
	...
	"Forgivness is the foundation of a meaningful, deep and good relationship." 
